                             ...
                             size_t nlabels, uint32_t *labels)
{
  ...
  stream_putw (s, 0);
  total_attr_len = bgp_packet_attribute (NULL, peer, s,
                                         attr, &p, AFI_INTERNAL_L2VPN, SAFI_INTERNAL_EVPN,
                                         bgp->peer_self, NULL, NULL, 0);
  pos_end = stream_get_endp (s);

  /* Encode the prefix in MP_REACH_NLRI attribute */
  mpattrlen_pos = bgp_packet_mpattr_start(s, AFI_INTERNAL_L2VPN, SAFI_INTERNAL_EVPN, attr);

  bgp_packet_mpattr_prefix(s, AFI_INTERNAL_L2VPN, SAFI_INTERNAL_EVPN, &p, rd, labels, nlabels, attr);
...
bgp_default_withdraw_evpn_send (struct peer *peer, afi_t afi, struct prefix_rd *rd)
{
  ...
  /* start to build MP_REACH_NLRI attribute */
  mpattrlen_pos = bgp_packet_mpunreach_start(s, AFI_INTERNAL_L2VPN, SAFI_INTERNAL_EVPN);

  /* Encode the prefix in MP_UNREACH_NLRI attribute */
  bgp_packet_mpunreach_prefix(s, &p, AFI_INTERNAL_L2VPN, SAFI_INTERNAL_EVPN, rd, labels, nlabels, NULL);
                               ...
                               struct attr *attr, u_int32_t ethtag, uint32_t label)
{
  ...
  bgp_packet_mpattr_prefix(s, AFI_INTERNAL_L2VPN, SAFI_INTERNAL_EVPN, &p, rd, &label, 1, attr);
                                  ...
                                  struct attr *attr, u_int32_t ethtag, uint32_t label)
{
  ...
  /* Encode the prefix in MP_UNREACH_NLRI attribute */
  bgp_packet_mpunreach_prefix(s, &p, AFI_INTERNAL_L2VPN, SAFI_INTERNAL_EVPN, rd, &label, 1, attr);
