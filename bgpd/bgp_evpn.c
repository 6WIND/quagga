...
bgp_ethernetvpn_init (void)
{
  ...
  install_element (ENABLE_NODE, &show_bgp_evpn_all_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_rd_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_all_tags_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_rd_tags_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_all_overlay_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_rd_overlay_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_all_neighbor_routes_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_rd_neighbor_routes_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_all_neighbor_advertised_routes_cmd);
  install_element (ENABLE_NODE, &show_bgp_evpn_rd_neighbor_advertised_routes_cmd);
}
