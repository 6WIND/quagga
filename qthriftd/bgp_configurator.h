...
struct _BgpConfiguratorIfInterface
{
  ...
  gboolean (*withdraw_route) (BgpConfiguratorIf *iface, gint32* _return, const protocol_type p_type, const gchar * prefix, const gchar * rd, const gint32 ethtag, const gchar * esi, const gchar * macaddress, GError **error);
...
gboolean bgp_configurator_if_withdraw_route (BgpConfiguratorIf *iface, gint32* _return, const protocol_type p_type, const gchar * prefix, const gchar * rd, const gint32 ethtag, const gchar * esi, const gchar * macaddress, GError **error);
