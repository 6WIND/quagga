...
struct _BgpConfiguratorIfInterface
{
  ...
  gboolean (*set_peer_secret) (BgpConfiguratorIf *iface, gint32* _return, const gchar * ipAddress, const gchar * rfc2385_sharedSecret, GError **error);
...
gboolean bgp_configurator_if_set_peer_secret (BgpConfiguratorIf *iface, gint32* _return, const gchar * ipAddress, const gchar * rfc2385_sharedSecret, GError **error);
