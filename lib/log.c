...
static const struct zebra_desc_table command_types[] = {
  ...
  DESC_ENTRY	(ZEBRA_IPV6_BFD_CNEIGH_LIST),
  DESC_ENTRY	(ZEBRA_IPV6_BFD_CNEIGH_ADD),
  DESC_ENTRY	(ZEBRA_IPV6_BFD_CNEIGH_DEL),
  DESC_ENTRY	(ZEBRA_IPV6_BFD_NEIGH_UP),
  DESC_ENTRY	(ZEBRA_IPV6_BFD_NEIGH_DOWN),
  DESC_ENTRY	(ZEBRA_BFD_REGISTER),
};
#undef DESC_ENTRY
